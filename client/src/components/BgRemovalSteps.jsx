    ...
    <div className='text-center mb-16 '>
      ...
      <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8'>
        ...
        {steps.map((item,index)=>(
          <div className='bg-gray-50 p-8 rounded-2xl shadow-sm' key={index}>
            
            <span className='inline-block bg-gray-200 text-indigo-800 text-sm font-semibold px-3 py-1 rounded-full mb-4'>{item.step}</span>
